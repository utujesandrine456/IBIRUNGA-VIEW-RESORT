    ...
    const sections = [
        ...
        },
        {
            ...
            data: JSON.stringify({
                ...
                title: 'Rooms & Suites',
                description: 'Five distinct wings named after Rwanda\'s iconic volcanoes — Bisoke, Sabyinyo, Karisimbi, Gahinga, and Muhabura. Each wing offers a unique experience with rooms priced from 30,000 Frw per night.',
            }),
        },
        {
            id: 'extra-meta',
